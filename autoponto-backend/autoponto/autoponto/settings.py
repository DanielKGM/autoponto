...
BIOMETRIC_UPLOAD_MIN_BODY_BYTES = int(FACE_MAX_CAPTURAS * FACE_MAX_IMAGE_BYTES * 1.5)
...
DATA_UPLOAD_MAX_MEMORY_SIZE = max(env_int("DATA_UPLOAD_MAX_MEMORY_SIZE"), BIOMETRIC_UPLOAD_MIN_BODY_BYTES)
