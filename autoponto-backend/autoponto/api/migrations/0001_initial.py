# Generated by Django 6.0.4 on 2026-06-25 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("vetor", models.JSONField(blank=True, default=list)),
                (
                    "status",
                    models.CharField(
                        choices=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("ativo", True), ("status", "ATIVO")),
                fields=("aluno",),
